    ...
    internal class LevelRoom : GameObject
    {
        ...
        public LevelRoom(Game game)
        {
            ...
            List<Wall> walls = new List<Wall>();
            {
                ...
                AddWall<Wall14>(Wall.Width * 0, _roomBounds.Height - Wall.Width * 4);
                AddWall<Wall13>(Wall.Width * 1, _roomBounds.Height - Wall.Width * 4);
                for (int i = 2; i < 5; i++)
                    AddWall<Wall1>(Wall.Width * i, _roomBounds.Height - Wall.Width * 4);
                AddWall<Wall7>(Wall.Width * 5, _roomBounds.Height - Wall.Width * 4);
                AddWall<Wall8>(Wall.Width * 5, _roomBounds.Height - Wall.Width * 3);
                for (int i = 7; i < 14; i++)
                    AddWall<Wall1>(Wall.Width * i, _roomBounds.Height - Wall.Width * 2);
                AddWall<Wall9>(Wall.Width * 14, _roomBounds.Height - Wall.Width * 3);
                for (int i = 4; i < 8; i++)
                    AddWall<Wall5>(Wall.Width * 15, _roomBounds.Height - Wall.Width * i);
                AddWall<Wall19>(Wall.Width * 15, _roomBounds.Height - Wall.Width * 8);
                AddWall<Wall18>(Wall.Width * 11, _roomBounds.Height - Wall.Width * 6);
                AddWall<Wall17>(Wall.Width * 10, _roomBounds.Height - Wall.Width * 6);
                AddWall<Wall16>(Wall.Width * 9, _roomBounds.Height - Wall.Width * 6);
                AddWall<Wall20>(Wall.Width * 15, _roomBounds.Height - Wall.Width * 9);
                for (int i = 8; i < 15; i++)
                    AddWall<Wall21>(Wall.Width * i, _roomBounds.Height - Wall.Width * 9);
                AddWall<Wall18>(Wall.Width * 6, _roomBounds.Height - Wall.Width * 6);
                AddWall<Wall16>(Wall.Width * 5, _roomBounds.Height - Wall.Width * 6);
                AddWall<Wall23>(Wall.Width * 6, _roomBounds.Height - Wall.Width * 10);
                AddWall<Wall18>(Wall.Width * 3, _roomBounds.Height - Wall.Width * 7);
                AddWall<Wall16>(Wall.Width * 2, _roomBounds.Height - Wall.Width * 7);
                for (int i = 11; i < 14; i++)
                    AddWall<Wall5>(Wall.Width * 7, _roomBounds.Height - Wall.Width * i);
                AddWall<Wall19>(Wall.Width * 7, _roomBounds.Height - Wall.Width * 14);
                AddWall<Wall20>(Wall.Width * 7, _roomBounds.Height - Wall.Width * 15);
                for (int i = 5; i < 7; i++)
                    AddWall<Wall21>(Wall.Width * i, _roomBounds.Height - Wall.Width * 15);
                AddWall<Wall27>(Wall.Width * 4, _roomBounds.Height - Wall.Width * 15);
                for (int i = 16; i < 17; i++)
                    AddWall<Wall28>(Wall.Width * 4, _roomBounds.Height - Wall.Width * i);
                AddWall<Wall12>(Wall.Width * 4, _roomBounds.Height - Wall.Width * 17);
                AddWall<Wall24>(Wall.Width * 2, _roomBounds.Height - Wall.Width * 13);
                AddWall<Wall21>(Wall.Width * 1, _roomBounds.Height - Wall.Width * 12);
                AddWall<Wall36>(Wall.Width * 0, _roomBounds.Height - Wall.Width * 12);
                for (int i = 14; i < 18; i++)
                    AddWall<Wall26>(Wall.Width * 2, _roomBounds.Height - Wall.Width * i);
                AddWall<Wall29>(Wall.Width * 2, _roomBounds.Height - Wall.Width * 18);
                AddWall<Wall25>(Wall.Width * 2, _roomBounds.Height - Wall.Width * 19);
                for (int i = 3; i < 8; i++)
                    AddWall<Wall21>(Wall.Width * i, _roomBounds.Height - Wall.Width * 19);
                AddWall<Wall11>(Wall.Width * 8, _roomBounds.Height - Wall.Width * 19);
                AddWall<Wall10>(Wall.Width * 8, _roomBounds.Height - Wall.Width * 20);
                AddWall<Wall30>(Wall.Width * 6, _roomBounds.Height - Wall.Width * 21);
                for (int i = 4; i < 6; i++)
                    AddWall<Wall1>(Wall.Width * i, _roomBounds.Height - Wall.Width * 21);
                AddWall<Wall8>(Wall.Width * 2, _roomBounds.Height - Wall.Width * 22);
                for (int i = 23; i < 27; i++)
                    AddWall<Wall26>(Wall.Width * 2, _roomBounds.Height - Wall.Width * i);
                AddWall<Wall33>(Wall.Width * 2, _roomBounds.Height - Wall.Width * 28);
                for (int i = 4; i < 7; i++)
                    AddWall<Wall34>(Wall.Width * i, _roomBounds.Height - Wall.Width * 28);
                AddWall<Wall35>(Wall.Width * 7, _roomBounds.Height - Wall.Width * 28);
                for (int i = 29; i * Wall.Width <= _roomBounds.Height; i++)
                    AddWall<Wall15>(Wall.Width * 7, _roomBounds.Height - Wall.Width * i);
                for (int i = 5; i < 8; i++)
                    AddWall<Wall1>(Wall.Width * i, _roomBounds.Height - Wall.Width * 17);
                AddWall<Wall30>(Wall.Width * 8, _roomBounds.Height - Wall.Width * 17);
                AddWall<Wall30>(Wall.Width * 10, _roomBounds.Height - Wall.Width * 16);
                AddWall<Wall7>(Wall.Width * 12, _roomBounds.Height - Wall.Width * 15);
                for (int i = 14; i < 15; i++)
                    AddWall<Wall26>(Wall.Width * 12, _roomBounds.Height - Wall.Width * i);
                AddWall<Wall8>(Wall.Width * 12, _roomBounds.Height - Wall.Width * 13);
                for (int i = 14; i < 20; i++)
                    AddWall<Wall1>(Wall.Width * i, _roomBounds.Height - Wall.Width * 12);
                AddWall<Wall31>(Wall.Width * 20, _roomBounds.Height - Wall.Width * 12);
                AddWall<Wall32>(Wall.Width * 21, _roomBounds.Height - Wall.Width * 12);
                for (int i = 13; i < 28; i++)
                    AddWall<Wall28>(Wall.Width * 21, _roomBounds.Height - Wall.Width * i);
                AddWall<Wall12>(Wall.Width * 21, _roomBounds.Height - Wall.Width * 28);
                AddWall<Wall18>(Wall.Width * 14, _roomBounds.Height - Wall.Width * 21);
                AddWall<Wall16>(Wall.Width * 13, _roomBounds.Height - Wall.Width * 21);
                AddWall<Wall23>(Wall.Width * 15, _roomBounds.Height - Wall.Width * 28);
                AddWall<Wall4>(Wall.Width * 16, _roomBounds.Height - Wall.Width * 29);
                AddWall<Wall10>(Wall.Width * 17, _roomBounds.Height - Wall.Width * 29);
                AddWall<Wall15>(Wall.Width * 17, _roomBounds.Height - Wall.Width * 28);
                AddWall<Wall11>(Wall.Width * 17, _roomBounds.Height - Wall.Width * 27);
                for (int i = 22; i < 24; i++)
                    AddWall<Wall1>(Wall.Width * i, _roomBounds.Height - Wall.Width * 28);
                AddWall<Wall10>(Wall.Width * 24, _roomBounds.Height - Wall.Width * 28);
                for (int i = 15; i < 28; i++)
                    AddWall<Wall15>(Wall.Width * 24, _roomBounds.Height - Wall.Width * i);
                AddWall<Wall14>(Wall.Width * 24, _roomBounds.Height - Wall.Width * 14);
                AddWall<Wall13>(Wall.Width * 25, _roomBounds.Height - Wall.Width * 14);
                for (int i = 25; i < 36; i++)
                    AddWall<Wall1>(Wall.Width * i, _roomBounds.Height - Wall.Width * 14);
                AddWall<Wall32>(Wall.Width * 36, _roomBounds.Height - Wall.Width * 14);
                for (int i = 15; i < 25; i++)
                    AddWall<Wall28>(Wall.Width * 36, _roomBounds.Height - Wall.Width * i);
                AddWall<Wall18>(Wall.Width * 31, _roomBounds.Height - Wall.Width * 28);
                AddWall<Wall16>(Wall.Width * 30, _roomBounds.Height - Wall.Width * 28);
                AddWall<Wall12>(Wall.Width * 36, _roomBounds.Height - Wall.Width * 25);
                AddWall<Wall10>(Wall.Width * 37, _roomBounds.Height - Wall.Width * 25);
                for (int i = 14; i < 25; i++)
                    AddWall<Wall15>(Wall.Width * 37, _roomBounds.Height - Wall.Width * i);
                AddWall<Wall11>(Wall.Width * 37, _roomBounds.Height - Wall.Width * 13);
                for (int i = 4; Wall.Width * i <= _roomBounds.Height; i++)
                    AddWall<Wall5>(Wall.Width * 39, _roomBounds.Height - Wall.Width * i);
                AddWall<Wall9>(Wall.Width * 38, _roomBounds.Height - Wall.Width * 3);
                for (int i = 18; i < 38; i++)
                    AddWall<Wall1>(Wall.Width * i, _roomBounds.Height - Wall.Width * 2);
                AddWall<Wall8>(Wall.Width * 16, _roomBounds.Height - Wall.Width * 3);
                for (int i = 4; i < 7; i++)
                    AddWall<Wall26>(Wall.Width * 16, _roomBounds.Height - Wall.Width * i);
                AddWall<Wall29>(Wall.Width * 16, _roomBounds.Height - Wall.Width * 7);
                AddWall<Wall25>(Wall.Width * 16, _roomBounds.Height - Wall.Width * 8);
                AddWall<Wall11>(Wall.Width * 17, _roomBounds.Height - Wall.Width * 8);
                for (int i = 9; i < 11; i++)
                    AddWall<Wall15>(Wall.Width * 17, _roomBounds.Height - Wall.Width * i);
                AddWall<Wall36>(Wall.Width * 17, _roomBounds.Height - Wall.Width * 11);
                for (int i = 18; i < 22; i++)
                    AddWall<Wall21>(Wall.Width * i, _roomBounds.Height - Wall.Width * 11);
                AddWall<Wall11>(Wall.Width * 22, _roomBounds.Height - Wall.Width * 11);
                AddWall<Wall15>(Wall.Width * 22, _roomBounds.Height - Wall.Width * 12);
                AddWall<Wall36>(Wall.Width * 22, _roomBounds.Height - Wall.Width * 13);
                for (int i = 23; i < 37; i++)
                    AddWall<Wall21>(Wall.Width * i, _roomBounds.Height - Wall.Width * 13);
                AddWall<Wall23>(Wall.Width * 19, _roomBounds.Height - Wall.Width * 6);
                AddWall<Wall21>(Wall.Width * 21, _roomBounds.Height - Wall.Width * 5);
                AddWall<Wall21>(Wall.Width * 22, _roomBounds.Height - Wall.Width * 5);
                AddWall<Wall11>(Wall.Width * 23, _roomBounds.Height - Wall.Width * 5);
                for (int i = 6; i < 9; i++)
                    AddWall<Wall15>(Wall.Width * 23, _roomBounds.Height - Wall.Width * i);
                AddWall<Wall5>(Wall.Width * 20, _roomBounds.Height - Wall.Width * 7);
                AddWall<Wall5>(Wall.Width * 20, _roomBounds.Height - Wall.Width * 8);
                AddWall<Wall4>(Wall.Width * 20, _roomBounds.Height - Wall.Width * 9);
                for (int i = 21; i < 23; i++)
                    AddWall<Wall1>(Wall.Width * i, _roomBounds.Height - Wall.Width * 9);
                AddWall<Wall10>(Wall.Width * 23, _roomBounds.Height - Wall.Width * 9);
                AddWall<Wall23>(Wall.Width * 33, _roomBounds.Height - Wall.Width * 10);
                AddWall<Wall10>(Wall.Width * 35, _roomBounds.Height - Wall.Width * 11);
                AddWall<Wall15>(Wall.Width * 35, _roomBounds.Height - Wall.Width * 10);
                AddWall<Wall11>(Wall.Width * 35, _roomBounds.Height - Wall.Width * 9);
                AddWall<Wall4>(Wall.Width * 34, _roomBounds.Height - Wall.Width * 11);
            }
